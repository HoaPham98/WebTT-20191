...
<%
	...
	List<XuatChieu> XuatChieuSchedule = (ArrayList<XuatChieu>) request.getAttribute("schedule");
		...
		<div class="time-select">
			<div class="time-select__group">
				<ul class="col-sm-8 items-wrap">
					<%
						for (XuatChieu XuatChieu : XuatChieuSchedule) {
								System.out.println(XuatChieu.getThoiGianChieu());
								String clsName = "";
								String showURL = null;
								switch (isToday) {
								case -1:
								...
								case 1:
									clsName = "";
									showURL = bookingURL + "&time=" + XuatChieu.getThoiGianChieu().replaceAll(" ", "_");
									break;
								default:
									break;
								}
					...
					<li class="time-select__item <%=clsName%>"
						data-time='XuatChieu.getTime().substring(0, 5)'
						onclick="bookSeat('<%=showURL%>')"><%=XuatChieu.getThoiGianChieu().substring(0, 5)%></li>
					<%
						}
					%>
				</ul>
