...
CREATE TABLE [dbo].[GiaoDich] (
  ...
  [NgayDat] date DEFAULT (CONVERT([date],getdate())) NULL,
  [GioDat] time(7) DEFAULT (CONVERT([time],getdate())) NULL
)
GO
